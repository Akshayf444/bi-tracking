            ...
            <table class="table table-bordered table-hover ">
                ...
                <?php foreach ($show as $row) :
                    ...
                    <tr>  
                        ...
                        <td><?php echo $row->Planned_Rx; ?><input type="hidden" name="Doctor_Id[]" value="<?php echo $row->Account_ID ?>"> <input type="hidden" name="BDM_ID" value="<?php echo isset($_POST['rx_id']) ? $_POST['rx_id'] : '' ?>"> </td>
